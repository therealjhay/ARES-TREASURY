...
- **Execution:** It uses a "Checks-Effects-Interactions" pattern—meaning we delete the proposal from the queue _before_ we trigger the code. This kills re-entrancy attacks in their tracks.
